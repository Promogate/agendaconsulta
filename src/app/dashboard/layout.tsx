...
export default function DashboardLayout({
  ...
  const navItems = [
    ...
    { href: '/dashboard/medicos', icon: Users, label: 'Medicos' },
    { href: '/dashboard/configuracoes', icon: Settings, label: 'Configurações' },
    { href: '/dashboard/atividades', icon: Activity, label: 'Atividades' },
    { href: '/dashboard/seguranca', icon: Shield, label: 'Segurança' },
  ];
